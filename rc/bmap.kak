	...
	evaluate-commands %sh{
		...
		for key in $keys; do
			...
			case $key in
				...
				'env_________edit') nor___="<space>"                         ; nor__s="<a-space>"                       ; nor_a_="<$>"                             ; nor_as="<_>"                             ; nor_c_=": delete-buffer<ret>"            ; nor_cs=""                                ;;
			...
			case $key in
				...
				'act__alternative') men___=": bmap-surround-change<ret>"     ; men__s=""                                ; men_a_=""                                ; men_as=""                                ;;
				...
				'env_______person') men___="<@>"                             ; men__s=""                                ; men_a_="<a-@>"                           ; men_as=""                                ;;
